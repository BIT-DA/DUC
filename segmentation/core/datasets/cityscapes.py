...
class cityscapesDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        label_mask.resize(label.shape[0], label.shape[1], 1)
        ...
        ret_data = {
            ...
            'label_mask': label_mask,  # for train
            ...
            'size': [h, w],  # for active to interpolate the output to original size
            'origin_mask': origin_mask,  # mask without transforms for active
            'origin_label': origin_label,  # label without transforms for active
            'active': active_indicator,  # indicate pixels can not be selected again
            'selected': active_selected,  # indicate the pixel have been selected
            'datafiles': datafiles        # path of data files
        }
