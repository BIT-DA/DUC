...
def build_classifier(cfg):
    ...
    if deeplab_name == 'deeplabv2':
        ...
        classifier = DepthwiseSeparableASPP(inplanes=2048, dilation_series=[1, 6, 12, 18], padding_series=[1, 6, 12, 18],
                                         num_classes=cfg.MODEL.NUM_CLASSES, norm_layer=bn_layer)
    else:
        raise NotImplementedError
    return classifier
